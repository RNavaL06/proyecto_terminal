            ...
            <div className="p-4 sm:p-6 space-y-6">
              ...
              <div className="bg-red-50 border-2 border-red-500 rounded-xl p-4 flex gap-3 items-start shadow-sm flex-col">
                ...
                <div>
                  ...
                  {faltanDatosMedico && <p className="text-sm text-red-800 font-medium leading-snug mt-5">No se detectó cédula profesional y/o el nombre del médico. Una receta médica sin una cédula visible carece de validez oficial y <strong>podría tratarse de un documento falso</strong>.</p>}
                </div>
