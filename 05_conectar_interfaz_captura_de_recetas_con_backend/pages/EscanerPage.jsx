...
import { analizarRecetaMedica } from '../services/api';
      ...
      {isModalOpen && datosClinicos && (
        <FormularioEdicionModal 
          ...
          onSave={(datosValidados) => {
            console.log("Datos listos para enviar a la base de datos:", datosValidados);
            toast.success("Información guardada en el historial");
