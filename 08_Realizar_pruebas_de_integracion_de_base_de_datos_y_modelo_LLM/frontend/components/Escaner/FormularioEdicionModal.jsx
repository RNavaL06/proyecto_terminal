...
import { X, Save, AlertOctagon, Loader2 } from 'lucide-react';
...
const FormularioEdicionModal = ({ datosIniciales, onClose, onSave }) => {
  ...
  return (
    <Dialog open={true} onClose={isSaving ? () => {} : onClose} className="relative z-50">
          ...
          <DialogPanel className="w-full max-w-md transform overflow-hidden rounded-3xl bg-slate-50 text-left align-middle shadow-2xl transition-all">
            ...
            <header className="bg-white px-6 py-4 flex items-center justify-between border-b border-slate-200">
              ...
              <button 
                onClick={onClose} 
                disabled={isSaving}
                className="p-2 bg-slate-100 rounded-full text-slate-500 hover:bg-slate-200 hover:text-slate-800 transition-colors focus:outline-none disabled:opacity-50"
              >
                <X className="w-5 h-5" />
              </button>
            </header>
            ...
            <div className="p-4 sm:p-6 space-y-6">
              ...
              <div className="bg-red-50 border-2 border-red-500 rounded-xl p-4 flex gap-3 items-start shadow-sm flex-col">
                <div className='flex flex-row items-center gap-2'>
                  <AlertOctagon className="w-7 h-7 text-red-600 flex-shrink-0" />
                  <h3 className="font-bold text-red-700 text-sm uppercase tracking-wider">Advertencia de Seguridad</h3>
                </div>
                ...
                <div>
                  ...
                  {faltanDatosMedico && (
                    <p className="text-sm text-red-800 font-medium leading-snug mt-3">
                      Además, no se detectó la cédula profesional o el nombre del médico. Una receta médica sin una cédula visible carece de validez oficial y <strong>podría tratarse de un documento falso</strong>.
                    </p>
                  )}
                </div>
              </div>
              ...
              <form onSubmit={handleConfirmar} className="space-y-6">
                ...
                <section className="bg-white p-4 rounded-2xl shadow-sm border border-slate-200">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      />
                      <p className="text-[10px] text-slate-400 mt-1 px-1">* Obligatorio para vincular la receta a tu expediente.</p>
                    </div>
                    <div>
                      ...
                      />
                      <p className="text-[10px] text-slate-400 mt-1 px-1">Opcional. Ayuda a categorizar tu receta.</p>
                    </div>
                    ...
                    <div>
                      ...
                      <textarea 
                        ...
                        className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
                      />
                      <p className="text-[10px] text-slate-400 mt-1 px-1">Opcional. Instrucciones generales emitidas por el médico.</p>
                    </div>
                  </div>
                </section>
                ...
                <section className="bg-white p-4 rounded-2xl shadow-sm border border-slate-200">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      />
                      <p className="text-[10px] text-emerald-600/80 font-medium mt-1 px-1">* Requerido (Si está vacío, se asignará un "Médico Desconocido").</p>
                    </div>
                    <div>
                      ...
                      <input 
                        ...
                        className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                      />
                      <p className="text-[10px] text-emerald-600/80 font-medium mt-1 px-1">* Requerido (Si está vacío, se guardará como "Sin Cédula").</p>
                    </div>
                  </div>
                </section>
                      ...
                      <div key={index} className="bg-white p-4 rounded-2xl shadow-sm border border-slate-200 relative overflow-hidden">
                        ...
                        <div className="space-y-3 pl-2">
                          <div>
                            ...
                            />
                            <p className="text-[10px] text-slate-400 mt-1 px-1">* Obligatorio para registrar el medicamento.</p>
                          </div>
                          <div className="grid grid-cols-2 gap-3">
                            <div>
                              ...
                              />
                              <p className="text-[10px] text-slate-400 mt-1 px-1">Opcional.</p>
                            </div>
                            <div>
                ...
                <div className="pt-4">
                  <button 
                    type="submit"
                    disabled={isSaving}
                    className="w-full flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600 disabled:bg-blue-300 text-white font-bold py-4 px-4 rounded-xl shadow-md transition-all cursor-pointer disabled:cursor-not-allowed"
                  >
                    {isSaving ? (
                      <>
